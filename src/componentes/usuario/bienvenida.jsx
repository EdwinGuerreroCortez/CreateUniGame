    ...
    <div className="section has-background-black-bis">
      <div className="container">
        <div className="columns is-centered">
          <div className="column is-half-tablet is-one-third-desktop" style={{ marginBottom: '1.5rem', marginRight: '1rem' }}> {/* Ajuste de columna para diferentes pantallas y margen */}
          ...
          <div className="column is-half-tablet is-one-third-desktop" style={{ marginBottom: '1.5rem', marginLeft: '1rem' }}> {/* Ajuste de columna para diferentes pantallas y margen */}
