            ...
            <div className="card custom-card">
              <div className="card-content has-text-centered">
                <div className="content">
                  ...
                  <a className="button is-primary is-rounded" href="https://unity.com/es/download" target="_blank" rel="noopener noreferrer">Descargar</a>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="columns is-centered">
          <div className="column is-one-third">
            <div className="card custom-card">
              <div className="card-content has-text-centered">
                <div className="content">
                  <h3 className="title is-4">Documentación de Unity</h3>
                  <p>Accede a la documentación oficial de Unity para obtener guías, tutoriales y ejemplos.</p>
                  <a className="button is-link is-rounded" href="https://docs.unity3d.com/Manual/index.html" target="_blank" rel="noopener noreferrer">Visitar</a>
                </div>
              </div>
            </div>
          </div>
          <div className="column is-one-third">
            <div className="card custom-card">
              <div className="card-content has-text-centered">
                <div className="content">
                  <h3 className="title is-4">Tutoriales de C#</h3>
                  <p>Encuentra tutoriales y recursos para aprender C# y mejorar tus habilidades de programación.</p>
                  <a className="button is-link is-rounded" href="https://learn.microsoft.com/es-es/dotnet/csharp/" target="_blank" rel="noopener noreferrer">Visitar</a>
                </div>
              </div>
            </div>
          </div>
