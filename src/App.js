...
import RecursosTemas from './componentes/administrativo/recursosTemas';
...
import Entradas from './componentes/administrativo/entradas'
import RecursosTemasDocete from './componentes/docente/recursosTemas';
  ...
  return (
    <Router basename="/studyweb">
      <Routes>
        ...
        <Route path="/admin/usuarios/entradas" element={<RutaPrivada rolesPermitidos={['administrador']}><LayoutEncabeAdmin><Entradas /></LayoutEncabeAdmin></RutaPrivada>} />
        ...
        <Route path="/admin/recursos" element={<RutaPrivada rolesPermitidos={['administrador']}><LayoutEncabeAdmin><RecursosTemas/></LayoutEncabeAdmin></RutaPrivada>} />
